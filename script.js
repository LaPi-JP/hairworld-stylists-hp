document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    en: {
      ...
      "about.lead": "Hairworld Stylists Rama2 offers hairstyle design, hair care, makeup, hairstyling, spa, and complete hair care services.",
    ...
    th: {
      ...
      "about.lead": "Hairworld Stylists Rama2 ให้บริการ ออกแบบทรงผม ดูแลเส้นผม บริการแต่งหน้า ทำผม สปา ดูแลเส้นผม ครบวงจร",
    ...
    ja: {
      ...
      "about.lead": "Hairworld Stylists Rama2 — ヘアデザイン、ヘアケア、メイク、ヘアスタイリング、スパなど、トータルヘアケアサービスを提供しています。",
