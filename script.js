document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    en: {
      ...
      "about.lead": "Hairworld Stylists Rama2<br>Offering hairstyle design, hair care, makeup, hairstyling, spa, and complete hair care services.",
      "about.text1": "Our team has extensive expertise and long experience, with a dedicated team to analyze hair, design and style hair, solve problems, and create the perfect style for you. We welcome all customers and aim to make every visit an impressive experience each and every time.",
    ...
    th: {
      ...
      "about.lead": "Hairworld Stylists Rama2<br>ให้บริการ ออกแบบทรงผม ดูแลเส้นผม บริการแต่งหน้า ทำผม สปา ดูแลเส้นผม ครบวงจร",
      "about.text1": "ทีมงาน เชี่ยวชาญประสบการณ์ ยาวนาน มีทีม วิเคราะห์เส้นผม ออกแบบตกแต่งทรงผม แก้ไขปัญหา ออกแบบดีไซน์ สไตล์ที่เหมาะกับคุณ เรายินดีต้อนรับลูกค้าทุกท่าน และตั้งใจให้ทุกครั้งที่มา เป็นประสบการณ์ ที่น่าประทับใจในทุกๆครั้งที่มาเยือน",
    ...
    ja: {
      ...
      "about.lead": "Hairworld Stylists Rama2<br>ヘアデザイン、ヘアケア、メイク、ヘアスタイリング、スパなど、トータルヘアケアサービスを提供しています。",
      "about.text1": "豊富な経験と専門知識を持つチームが、髪質の分析・ヘアデザイン・トラブル解決・お客様に最適なスタイルのデザインをいたします。すべてのお客様を心より歓迎し、毎回のご来店が印象深い体験となるよう努めています。",
